...
namespace VoxelBusters.EssentialKit.Demo
{
    public class NotificationServicesDemo : DemoActionPanelBase<NotificationServicesDemoAction, NotificationServicesDemoActionType>
    {
            ...
            switch (selectedAction.ActionType)
            {
                ...
                case NotificationServicesDemoActionType.ScheduleNotification:
                    ...
                    var     newNotification2        = NotificationBuilder.CreateNotification(newNotificationID2)
                        ...
                        //.SetCalendarNotificationTrigger(CreateDateComponents(), repeats: false)
                        .Create();
        ...
        private DateComponents CreateDateComponents()
        {
            ...
            var scheduled = DateTime.Now.AddSeconds(10);

            dateComponents.Year = scheduled.Year;
            dateComponents.Month = scheduled.Month;
            dateComponents.Day = scheduled.Day;
            dateComponents.Hour = scheduled.Hour;
            dateComponents.Minute = scheduled.Minute;
