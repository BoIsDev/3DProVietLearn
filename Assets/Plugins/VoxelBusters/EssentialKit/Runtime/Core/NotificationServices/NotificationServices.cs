    ...
    public static class NotificationServices
    {
        ...
        internal   static  INativeNotificationCenterInterface    NativeInterface
        {
            get
            {
                ...
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Notification Services is not enabled. You need to enable this feature to use it."));
                }
        ...
        public static void Initialize(NotificationServicesUnitySettings settings)
        {
            ...
            // Configure interface
            NativeInterface       = NativeFeatureActivator.CreateInterface<INativeNotificationCenterInterface>(ImplementationSchema.NotificationServices, true);
        ...
        public static void ScheduleNotification(INotification notification, CompletionCallback callback = null)
        {
            ...
            {
                // make request
                NativeInterface.ScheduleNotification(notification, (success, error) =>
                {
        ...
        public static void GetScheduledNotifications(EventCallback<NotificationServicesGetScheduledNotificationsResult> callback = null)
        {
            ...
            {
                // make native request
                NativeInterface.GetScheduledNotifications((notifications, error) =>
                {
        ...
        { 
            ...
            {
                // make request
                NativeInterface.CancelScheduledNotification(notificationId);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        { 
            ...
            {
                // make request
                NativeInterface.CancelScheduledNotification(notification.Id);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void CancelAllScheduledNotifications()
        {
            ...
            {
                // make request
                NativeInterface.CancelAllScheduledNotifications();
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void GetDeliveredNotifications(EventCallback<NotificationServicesGetDeliveredNotificationsResult> callback = null)
        {
            ...
            {
                // make request
                NativeInterface.GetDeliveredNotifications((notifications, error) =>
                {
                    // avoid passing null
                    notifications       = notifications ?? new INotification[0];  
        ...
        public static void RemoveAllDeliveredNotifications()
        {
            ...
            {
                // make request
                NativeInterface.RemoveAllDeliveredNotifications();
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void RegisterForPushNotifications(EventCallback<NotificationServicesRegisterForPushNotificationsResult> callback = null)
        {
            ...
            {
                // make request
                NativeInterface.RegisterForPushNotifications((deviceToken, error) =>
                {
                    // cache device token 
                    if (null == error)
                    {
        ...
        public static void UnregisterForPushNotifications()
        {
            ...
            {
                // make request
                NativeInterface.UnregisterForPushNotifications();
        ...
        public static bool IsRegisteredForPushNotifications()
        {
            ...
            {
                // make request
                return NativeInterface.IsRegisteredForPushNotifications();
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void SetApplicationIconBadgeNumber(int count)
        {
            ...
            {
                // make request
                NativeInterface.SetApplicationIconBadgeNumber(count);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        {
            NativeInterface.OnNotificationReceived    += HandleNotificationReceivedInternalCallback;
        }
        ...
        private static void RequestPermissionInternal(NotificationPermissionOptions options, EventCallback<NotificationServicesRequestPermissionResult> callback = null)
        {
            ...
            {
                // make request
                NativeInterface.RequestPermission(options, (permissionStatus, accessError) =>
                {
        ...
        private static void GetSettingsInternal(bool sendUpdateEvent, Callback<NotificationServicesGetSettingsResult> callback = null)
        {
            ...
            {
                // make request
                NativeInterface.GetSettings((settings) =>
                {
                    // cache result
