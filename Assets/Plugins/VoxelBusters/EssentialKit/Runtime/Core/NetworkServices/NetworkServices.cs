...
namespace VoxelBusters.EssentialKit
{
    ...
    public static class NetworkServices
    {
        ...
        private     static  INativeNetworkServicesInterface    NativeInterface
        {
            get
            {
                if(s_nativeInterface == null)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Network Services is not enabled. You need to enable this feature to use it."));
                }
        ...
        public static void Initialize(NetworkServicesUnitySettings settings)
        {
            ...
            // Configure interface
            NativeInterface       = NativeFeatureActivator.CreateInterface<INativeNetworkServicesInterface>(ImplementationSchema.NetworkServices, true);
        ...
        {
            NativeInterface.OnInternetConnectivityChange  += HandleInternetConnectivityChangeInternalCallback;
            NativeInterface.OnHostReachabilityChange      += HandleHostReachabilityChangeInternalCallback;
        }
