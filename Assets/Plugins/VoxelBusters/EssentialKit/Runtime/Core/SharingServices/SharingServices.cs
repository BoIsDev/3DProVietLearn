    ...
    public static class SharingServices
    {
        ...
        internal   static  INativeSharingInterface    NativeInterface
        {
            get
            {
                ...
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Sharing Services is not enabled. You need to enable this feature to use it."));
                }
        ...
        public static void Initialize(SharingServicesUnitySettings settings)
        {
            ...
            // Configure interface
            NativeInterface       = NativeFeatureActivator.CreateInterface<INativeSharingInterface>(ImplementationSchema.SharingServices, true);
        }
