...
namespace VoxelBusters.EssentialKit
{
    ...
    public static class BillingServices
    {
        ...
        private     static  INativeBillingServicesInterface    NativeInterface
        {
            get
            {
                if(s_nativeInterface == null)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Billing Services is not enabled. You need to enable this feature to use it."));
                }
        ...
        public static void Initialize(BillingServicesUnitySettings settings)
        {
            ...
            // Configure interface
            NativeInterface           = NativeFeatureActivator.CreateInterface<INativeBillingServicesInterface>(ImplementationSchema.BillingServices, true);
        ...
        public static void InitializeStore(BillingProductDefinition[] productDefinitions)
        {
            ...
            try
            {
                ...
                // make request
                NativeInterface.RetrieveProducts(ProductDefinitions);
            }
        ...
        public static bool CanMakePayments()
        {
            ...
            {
                // make request
                return NativeInterface.CanMakePayments();
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static bool BuyProduct(IBillingProduct product, int quantity = 1, string applicationUsername = null)
        {
            ...
            try
            {
                ...
                // make request           
                Error   error;
                if (NativeInterface.StartPayment(newPayment, out error))
                {
                    return true;
                }
        ...
        public static IBillingTransaction[] GetTransactions()
        {
            ...
            {
                // make request
                return NativeInterface.GetTransactions() ?? new IBillingTransaction[0];
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void FinishTransactions(IBillingTransaction[] transactions)
        {
            ...
            try
            {
                ...
                {
                    NativeInterface.FinishTransactions(finishableTransactions);
                }
            }
            catch (Exception exception)
            {
        ...
        public static void RestorePurchases(string applicationUsername = null)
        {
            ...
            {
                // make request
                NativeInterface.RestorePurchases(applicationUsername);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        {
            NativeInterface.OnRetrieveProductsComplete    += HandleOnRetrieveProductsComplete;
            NativeInterface.OnTransactionStateChange      += HandleOnTransactionStateChange;
            NativeInterface.OnRestorePurchasesComplete    += HandleOnRestorePurchasesComplete;
        }
        ...
        private static void HandleOnRetrieveProductsComplete(IBillingProduct[] products, string[] invalidProductIds, Error error)
        {
            ...
            if (error == null)
            {
                if (NativeInterface.TryClearingUnfinishedTransactions())
                {
