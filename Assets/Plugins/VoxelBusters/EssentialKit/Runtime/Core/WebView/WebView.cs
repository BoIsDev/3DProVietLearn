...
namespace VoxelBusters.EssentialKit
{
    ...
    public sealed class WebView : NativeFeatureBehaviour
    {
        ...
        #region Static properties
         ...
         private  INativeWebView    NativeInterface
        {
            get
            {
                if(m_nativeInterface == null)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Web View feature is not enabled. You need to enable this feature to use it."));
                }
        ...
        public string Title
        {
            get
            {
                try
                {
                    return NativeInterface.GetTitle();
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public Rect Frame
        {
            ...
            set
            {
                try
                {
                    ...
                    NativeInterface.SetFrame(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public WebViewStyle Style
        {
            ...
            set
            {
                try
                {
                    ...
                    // apply changes to native object
                    NativeInterface.SetStyle(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public bool ScalesPageToFit
        {
            ...
            set
            {
                try
                {
                    ...
                    // apply changes to native object
                    NativeInterface.SetScalesPageToFit(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public bool CanBounce
        {
            ...
            set
            {
                try
                {
                    ...
                    // apply changes to native object
                    NativeInterface.SetCanBounce(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public Color BackgroundColor
        {
            ...
            set
            {
                try
                {
                    ...
                    // apply changes to native object
                    NativeInterface.SetBackgroundColor(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public double Progress
        {
            get
            {
                try
                {
                    return NativeInterface.GetProgress();
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public bool IsLoading
        {
            get
            {
                try
                {
                    return NativeInterface.GetIsLoading();
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public bool JavaScriptEnabled
        {
            ...
            set
            {
                try
                {
                    ...
                    // apply changes to native object
                    NativeInterface.SetJavaScriptEnabled(value);
                }
                catch (Exception exception)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        protected override void AwakeInternal(object[] args)
        {
            ...
            NativeInterface   = NativeFeatureActivator.CreateInterface<INativeWebView>(ImplementationSchema.WebView, true);
        ...
        public void LoadURL(URLString url)
        {
            ...
            try
            {
                NativeInterface.LoadURL(url.ToString());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public void LoadHtmlString(string htmlString, URLString? baseURL = null)
        {
            ...
            try
            {
                NativeInterface.LoadHtmlString(htmlString, baseURL.ToString());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public void LoadData(byte[] data, string mimeType, string textEncodingName, URLString? baseURL = null)
        {
            ...
            try
            {
                NativeInterface.LoadData(data, mimeType, textEncodingName, baseURL.ToString());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public void RunJavaScript(string script, EventCallback<WebViewRunJavaScriptResult> callback)
        {
            ...
            {
                // make request
                NativeInterface.RunJavaScript(script, (jsResult, jsError) =>
                {
        ...
        public void AddURLScheme(string urlScheme)
        {
            try
            {
                NativeInterface.AddURLScheme(urlScheme);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        {
            NativeInterface.OnShow       += HandleOnWebViewShow;
            NativeInterface.OnHide       += HandleOnWebViewHide;
            NativeInterface.OnLoadStart  += HandleOnWebViewLoadStart;
            NativeInterface.OnLoadFinish += HandleOnWebViewLoadFinish;
            NativeInterface.OnURLSchemeMatchFound += HandleOnURLSchemeMatchFound;
        }
