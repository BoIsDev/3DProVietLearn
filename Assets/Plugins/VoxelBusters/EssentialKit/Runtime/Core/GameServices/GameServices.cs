...
namespace VoxelBusters.EssentialKit
{
    ...
    public static class GameServices
    {
        ...
        private     static  INativeGameServicesInterface    NativeInterface
        {
            get
            {
                if(s_nativeInterface == null)
                {
                    DebugLogger.LogException(EssentialKitDomain.Default, new Exception("Game Services is not enabled. You need to enable this feature to use it."));
                }
        ...
        public static ILocalPlayer LocalPlayer
        {
            get
            {
                try
                {
                    return (NativeInterface != null) ? NativeInterface.GetLocalPlayer() : new NullLocalPlayer();
                }
        ...
        public static void Initialize(GameServicesUnitySettings settings)
        {
            ...
            // Configure interface
            NativeInterface       = NativeFeatureActivator.CreateInterface<INativeGameServicesInterface>(ImplementationSchema.GameServices, true);
            NativeInterface.SetCanShowAchievementCompletionBanner(UnitySettings.ShowAchievementCompletionBanner);
            NativeInterface.SetAuthChangeCallback(HandleAuthChangeInternalCallback);
        }
        ...
        public static ILeaderboard CreateLeaderboard(string leaderboardId)
        {
            ...
            {
                // create object
                return NativeInterface.CreateLeaderboard(settings.Id, settings.GetPlatformIdForActivePlatform());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void LoadLeaderboards(EventCallback<GameServicesLoadLeaderboardsResult> callback)
        {
            ...
            {
                // make request
                NativeInterface.LoadLeaderboards((leaderboards, error) => SendLoadLeaderboardsResult(callback, leaderboards, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static IAchievement CreateAchievement(string achievementId)
        {
            ...
            {
                // make request
                return NativeInterface.CreateAchievement(settings.Id, settings.GetPlatformIdForActivePlatform());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void LoadAchievementDescriptions(EventCallback<GameServicesLoadAchievementDescriptionsResult> callback)
        {
            ...
            {
                // make request
                NativeInterface.LoadAchievementDescriptions((descriptions, error) => SendLoadAchievementDescriptionsResult(callback, descriptions, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void LoadAchievements(EventCallback<GameServicesLoadAchievementsResult> callback)
        {
            ...
            {
                // make request
                NativeInterface.LoadAchievements((achievements, error) => SendLoadAchievementsResult(callback, achievements, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void LoadPlayers(string[] playerIds, EventCallback<GameServicesLoadPlayersResult> callback)
        {
            ...
            {
                // make request
                NativeInterface.LoadPlayers(playerIds, (players, error) => SendLoadPlayersResult(callback, players, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static IScore CreateScore(string leaderboardId)
        {
            ...
            {
                // create object
                return NativeInterface.CreateScore(settings.Id, settings.GetPlatformIdForActivePlatform());
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static IScore CreateScore(ILeaderboard leaderboard)
        {
            ...
            {
                // create object
                return NativeInterface.CreateScore(leaderboard.Id, leaderboard.PlatformId);
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void ShowLeaderboards(LeaderboardTimeScope timescope = LeaderboardTimeScope.AllTime, EventCallback<GameServicesViewResult> callback = null)
        {
            ...
            {
                // make request
                NativeInterface.ShowLeaderboard(
                    leaderboardId: null,
        ...
        public static void ShowAchievements(EventCallback<GameServicesViewResult> callback = null)
        {
            try
            {
                NativeInterface.ShowAchievements((error) => SendViewClosedResult(callback, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
        ...
        public static void LoadServerCredentials(EventCallback<GameServicesLoadServerCredentialsResult>  callback)
        {
            try
            {
                NativeInterface.LoadServerCredentials((credentials, error) => SendLoadServerCredentialsResult(callback, credentials, error));
            }
            catch (Exception exception)
            {
                DebugLogger.LogException(EssentialKitDomain.Default, exception);
