...
namespace VoxelBusters.EssentialKit.Editor.Build.Android
{
	...
	public class AndroidLibraryDependenciesGenerator
	{
		...
		private static readonly string BillingClientVersionString		= "6.2.1+";
		private static readonly string PlayServicesVersionString		= "23.2.0+";
		private static readonly string PlayServicesNearByVersionString	= "17.0.0+";
		private static readonly string PlayServicesAuthVersionString	= "21.2.0+";
